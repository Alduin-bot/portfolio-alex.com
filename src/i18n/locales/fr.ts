export const fr = {
  ...
  projects: {
    title: 'Mes Projets',
    description: 'Découvrez mes réalisations par catégorie',
    categories: {
      showcase: 'Site Vitrine',
      ecommerce: 'E-commerce',
      business: 'Logiciel Métier'
    },
    showcase: {
      project1: {
  ...
  about: {
    ...
    description: 'Développeur passionné par les nouvelles technologies et l\'innovation, je crée des solutions web modernes et performantes.',
    skills: {
    ...
    services: {
      ...
      frontendDesc: 'Interfaces modernes et réactives',
      backendDesc: 'APIs robustes et évolutives',
      responsiveDesc: 'Adaptation parfaite sur tous les écrans',
      databaseDesc: 'Gestion efficace des données'
    }
  },
  contact: {
    title: 'Contact',
    description: 'N\'hésitez pas à me contacter pour vos projets',
    form: {
      name: 'Votre nom',
      email: 'Votre email',
